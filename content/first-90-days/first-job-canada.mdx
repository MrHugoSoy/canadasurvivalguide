...
### Make sure your CV is Canadian-format
If you applied with a LATAM-style resume, update it before your first day in case you need to share it internally or apply for internal positions later. [Resumika](https://resumika.com) is a tool built specifically for creating Canadian-format CVs that pass ATS filters.
